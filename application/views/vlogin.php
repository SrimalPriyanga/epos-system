...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .{background:rgb(182, 142, 38); padding:18px 18px 14px; max-width:444px; text-align:center; border:4px solid #fff;margin:0 auto -80px; min-height:130px; box-shadow: 0 0 188px rgb(101, 102, 101);}
            .clr{clear:both;}
            ...
            .comingsoonBlk {background: rgb(144, 80, 49);color: #fff; border-color:rgb(227, 141, 19);}
